  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <StatCard title="Net Profit (Loss)" value={`${settings.currencySymbol}${totalProfit.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`} change={`${profitChange} from last month`} changeType={currentMonthData.profit >= prevMonthData.profit ? "positive" : "negative"} icon={TrendingUp} iconColor="bg-green-100" />
